...
Delegate the comprehensive architecture review to the `architecture-reviewer`
subagent.

Use the **task tool** with:

- `subagent_type`: "architecture-reviewer"
- `prompt`: Include the project context above and request a review across all 15
  dimensions:
