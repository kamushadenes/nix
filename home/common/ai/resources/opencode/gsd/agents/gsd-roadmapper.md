...
Reference full template: `/private$HOME/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/private$HOME/.config/opencode/get-shit-done/templates/state.md`.
