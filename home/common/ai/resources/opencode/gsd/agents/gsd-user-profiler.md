...
<reference>
@/private$HOME/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/private$HOME/.config/opencode/get-shit-done/references/user-profiling.md` to load:
