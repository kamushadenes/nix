...
See /private$HOME/.config/opencode/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /private$HOME/.config/opencode/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /private$HOME/.config/opencode/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /private$HOME/.config/opencode/get-shit-done/templates/discovery.md
...
Use /private$HOME/.config/opencode/get-shit-done/templates/discovery.md.
