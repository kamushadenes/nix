...
```bash
UI_AUDITOR_MODEL=$(node "/private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-ui-auditor --raw)
```
...
```markdown
Read /private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/agents/gsd-ui-auditor.md for instructions.
...
```bash
node "/private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
