...
```bash
AUDITOR_MODEL=$(node "/private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-nyquist-auditor --raw)
NYQUIST_CFG=$(node "/private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/get-shit-done/bin/gsd-tools.cjs" config get workflow.nyquist_validation --raw)
```
...
```
Task(
  prompt="Read /private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/get-shit-done/templates/VALIDATION.md`
...
node "/private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.EL9PeBxidH/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update validation strategy"
```
