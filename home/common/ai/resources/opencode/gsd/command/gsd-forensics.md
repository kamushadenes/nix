...
<execution_context>
@/private$HOME/.config/opencode/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/private$HOME/.config/opencode/get-shit-done/workflows/forensics.md end-to-end.
</process>
