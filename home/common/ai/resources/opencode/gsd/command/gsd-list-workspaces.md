...
<execution_context>
@/private$HOME/.config/opencode/get-shit-done/workflows/list-workspaces.md
@/private$HOME/.config/opencode/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @/private$HOME/.config/opencode/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
