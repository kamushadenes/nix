...
<execution_context>
@/private$HOME/.config/opencode/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @/private$HOME/.config/opencode/get-shit-done/workflows/code-review-fix.md end-to-end.
