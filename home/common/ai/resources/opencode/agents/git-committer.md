---
description:
  Git workflow agent for commits and PRs. Use for isolated git operations.
...
- Incorporate the task context provided in your prompt (what was being worked
  on)
...
5. Create PR: `gh pr create --title "..." --body "..."`
   - If `--base <branch>` is in extra instructions: add `--base <branch>` to
     target that branch
