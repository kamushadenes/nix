---
description:
  Reduces code complexity. Use PROACTIVELY when code is hard to understand or
  maintain.
...
1. Complexity metrics (cyclomatic > 10, cognitive > 15, nesting > 4, function
   length > 50)
2. Over-abstraction (unnecessary layers, pattern overuse, premature
   generalization)
...
**File**: `billing/processor.py:89` **Issue**: Too many decision branches
