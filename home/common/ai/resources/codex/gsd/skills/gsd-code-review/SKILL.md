...
<execution_context>
@/private$HOME/.codex/get-shit-done/workflows/code-review.md
</execution_context>
...
Execute the code-review workflow from @/private$HOME/.codex/get-shit-done/workflows/code-review.md end-to-end.
