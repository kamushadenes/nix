...
<execution_context>
@/private$HOME/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @/private$HOME/.codex/get-shit-done/workflows/add-tests.md end-to-end.
