...
<execution_context>
@/private$HOME/.codex/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @/private$HOME/.codex/get-shit-done/workflows/execute-phase.md end-to-end.
