...
<execution_context>
@/private$HOME/.codex/get-shit-done/workflows/resume-project.md
</execution_context>

<process>
**Follow the resume-project workflow** from `@/private$HOME/.codex/get-shit-done/workflows/resume-project.md`.
