...
<execution_context>
@/private$HOME/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@/private$HOME/.codex/get-shit-done/workflows/check-todos.md`.
