...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.F2f1uneqM8/.codex
                  → checks /private$HOME/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /private$HOME/.codex/get-shit-done
                  → writes to /private$HOME/.codex/get-shit-done/hooks/
...
@/private$HOME/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/private$HOME/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/private$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/private$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/private$HOME/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
