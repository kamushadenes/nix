---
name: doc-writer
description: Documentation writing agent. Spawned by /docs skill to write one document per assignment. Receives doc type, mode, project brief, and reference template.
