...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /private/var/folders/jl/yb1gyxfs0gx15sjsjp2zt5w40000gn/T/tmp.39LCycHXJP/.claude
                  → checks /private$HOME/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /private$HOME/.claude/get-shit-done
                  → writes to /private$HOME/.claude/get-shit-done/hooks/
...
@/private$HOME/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/private$HOME/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
