...
<execution_context>
@/private$HOME/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/private$HOME/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
