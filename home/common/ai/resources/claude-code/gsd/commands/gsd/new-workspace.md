...
<execution_context>
@/private$HOME/.claude/get-shit-done/workflows/new-workspace.md
@/private$HOME/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/private$HOME/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
