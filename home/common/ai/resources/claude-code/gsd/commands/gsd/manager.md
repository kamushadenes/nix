...
<execution_context>
@/private$HOME/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/private$HOME/.claude/get-shit-done/workflows/manager.md end-to-end.
