...
Intel system is disabled. To activate:
  ...
  node /private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /private$HOME/.claude/get-shit-done/bin/gsd-tools.cjs
