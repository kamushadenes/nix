...
<execution_context>
@/private$HOME/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/private$HOME/.claude/get-shit-done/workflows/docs-update.md end-to-end.
