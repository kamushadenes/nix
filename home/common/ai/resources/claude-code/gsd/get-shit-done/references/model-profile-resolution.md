...
**Note:** Opus-tier agents resolve to `"opus"`. The Task tool's model parameter accepts `"opus"`, `"sonnet"`, or `"haiku"` — do NOT pass `"inherit"` as it is not a valid model value.
