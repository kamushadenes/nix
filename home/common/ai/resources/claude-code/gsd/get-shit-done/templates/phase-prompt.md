...
<!-- For checkpoint task examples and patterns, see @/private$HOME/.claude/get-shit-done/references/checkpoints.md -->
...
See `/private$HOME/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/private$HOME/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/private$HOME/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
