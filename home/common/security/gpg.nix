{ pkgs, config, ... }:
{
  age.secrets = {
    "341C34CD6BED86F0FFC045609BFB331DE0590F01.key.age" = {
      file = ./resources/gpg/private-keys-v1.d/341C34CD6BED86F0FFC045609BFB331DE0590F01.key.age;
    ...
    "C47C3D2E60A2BD8D72E025AD0DB9C0C6E8CA2F76.key.age" = {
      file = ./resources/gpg/private-keys-v1.d/C47C3D2E60A2BD8D72E025AD0DB9C0C6E8CA2F76.key.age;
    ...
    "CB456C8ACD2B6E442EFAE57EE2BBC93F97B77037.key.age" = {
      file = ./resources/gpg/private-keys-v1.d/CB456C8ACD2B6E442EFAE57EE2BBC93F97B77037.key.age;
    ...
    "D6D774C67E02990E2C1618D03CF448155C21B39B.key.age" = {
      file = ./resources/gpg/private-keys-v1.d/D6D774C67E02990E2C1618D03CF448155C21B39B.key.age;
