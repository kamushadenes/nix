...
| [Contributing Guide](../CONTRIBUTING.md) | Prerequisites, workflow, adding modules/machines, code style, commit conventions           |
| [Changelog](../CHANGELOG.md)             | Major milestones and notable changes by date                                               |
